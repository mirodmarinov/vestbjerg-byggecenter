 ...
 * for Vestbjerg Byggecenter. This class contains the 
 * different dialogs for creating and editing products
 * in the system.
 */
...
public class ProductDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public ProductDialog(ProductsPanel productsPanel, int placeOnList, ProductCtr productCtr,boolean isEditProduct) {
